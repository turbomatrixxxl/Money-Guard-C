...
import Dragos from '../../../src/images/members-pictures/Dragos.webp';
import catalin from '../../../src/images/members-pictures/catalin.webp';
import Radu from '../../images/members-pictures/Radu.webp';
import Stefan from '../../images/members-pictures/Stefan.webp';
      ...
      <div className={styles.modalBg}>
        <div className={styles.modalContent}>
          ...
          <div className={styles.footerCards}>
            {/* Card pentru Dragos*/}
            <div className={`${styles.footerTeamCard} ${animation} ${styles.Dragos}`}>
              <img
            ...
            {/* Card pentru Radu */}
            <div className={`${styles.footerTeamCard} ${animation} ${styles.Radu}`}>
              <img
                src={Radu} // Folosește variabila corectă pentru imagine
                alt="Radu"
                className={styles.teamMemberImage}
              />
              <span className={styles.footerTeamName}>Naramzoiu Radu Bogdan</span>
            ...
            {/* Card pentru Stefan */}
            <div className={`${styles.footerTeamCard} ${animation} ${styles.Stefan}`}>
              <img
                src={Stefan} // Folosește variabila corectă pentru imagine
                alt="Stefan"
                className={styles.teamMemberImage}
              />
              <span className={styles.footerTeamName}>Craciun Stefan Marian</span>
              <em className={styles.footerTeamFunction}>Developer</em>
              <div className={styles.socialLinks}>
                <a href="https://github.com/Fear3dB3ard" className={styles.footerGithubIcon} aria-label="GitHub profile" target="_blank" rel="noreferrer noopener">
                  <FaGithub />
                </a>
                <a href="https://www.linkedin.com/in/stefan-marian-craciun-73b766199/" className={styles.footerLinkedinIcon} aria-label="LinkedIn profile" target="_blank" rel="noreferrer noopener">
                  <FaLinkedin />
                </a>
              </div>
            </div>
